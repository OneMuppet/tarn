...
[v0.7.1 release](https://github.com/OneMuppet/tarn/releases/tag/v0.7.1):

```sh
# macOS (Apple Silicon)
curl -L https://github.com/OneMuppet/tarn/releases/download/v0.7.1/tarn-v0.7.1-aarch64-apple-darwin.tar.gz | tar xz

# Linux (x86_64)
curl -L https://github.com/OneMuppet/tarn/releases/download/v0.7.1/tarn-v0.7.1-x86_64-unknown-linux-gnu.tar.gz | tar xz
```
...
**Quality.** 26 commands, **164 tests**, gated by adversarial review on every
